  ...
  return (
    <form action={action} className="space-y-5" noValidate>
      ...
      <Field label="Password" name="password" type="password" autoComplete="new-password" required
        hint="At least 8 characters." error={state.fieldErrors?.password} />
      ...
      <p className="text-caption muted">
        Your profile starts followers-only and your routes start private. You can change
        both at any time in Privacy.
      </p>
    </form>
  );
}
