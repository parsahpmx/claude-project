...
export const metadata = {
  title: 'Recovery',
  description:
    'Mobility, sleep, breathing and recovery protocols — scheduled as work, not as an afterthought.',
};
        ...
        <div className="grid gap-12 pt-16 lg:grid-cols-[1.2fr_1fr] lg:items-center">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-relaxed text-bone-200/70">
              FORGE scores your readiness every morning from sleep, HRV, resting heart rate and how
              you actually feel — then tells you whether today is a push day or a hold day, and why.
            </p>
            <div className="mt-9 flex flex-wrap gap-3">
              <ButtonLink href="/assessment" size="lg">
                Start Free Trial
              </ButtonLink>
              <ButtonLink href="#sessions" variant="inverse" size="lg">
                Browse Sessions
              </ButtonLink>
            </div>
          </div>
              ...
              {[
                ...
                <li key={label as string}>
                  ...
                  <div className="mt-2 h-1 overflow-hidden rounded-pill bg-bone-200/10">
                    <div
                      className="h-full rounded-pill bg-ember"
      ...
      <Section tone="light" size="md">
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 xl:grid-cols-3">
          {[
            ...
            [
              'HRV · 30%',
              'Overnight average against your baseline. Direction matters more than the number.',
            ],
            [
              'Resting heart rate · 15%',
              'Inverted: a rise above your baseline is the warning signal.',
            ],
            [
              'Soreness · 15%',
              'Self-reported. It is a signal, not a verdict — soreness tracks novelty more than quality.',
            ],
            [
              'Stress · 10%',
              'Life load counts. A hard week at work costs the same recovery as a hard week of training.',
            ],
            [
              'Missing data',
              'Dropped and renormalised. FORGE never fills a gap with a number you did not record.',
            ],
          ].map(([title, body]) => (
            <Card key={title}>
