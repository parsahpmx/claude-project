...
export const metadata = {
  title: 'For Coaches',
  description:
    'Coach more. Admin less. Client management, program builder, payments and analytics in one place.',
};

const FEATURES = [
  [
    'Client management',
    'Every client’s plan, history, check-ins and notes on one screen — with adherence surfaced before you have to look for it.',
  ],
  [
    'Program builder',
    'Drag-and-drop the week. Sets, reps, load, RPE, tempo, rest, notes and a video per exercise.',
  ],
  [
    'Calendar',
    'Consultations, coaching calls and check-in deadlines in one view, in your clients’ time zones.',
  ],
  [
    'Video sessions',
    'One-to-one calls with the session plan, your notes and their metrics beside the video.',
  ],
  [
    'Messaging',
    'Text, voice notes, video and documents. Form checks arrive with a timeline you can annotate.',
  ],
  ['Payments', 'Subscriptions, one-off sessions and payouts, itemised. No chasing invoices.'],
  [
    'Progress tracking',
    'Strength, volume, consistency and recovery per client, without exporting anything.',
  ],
  [
    'Form reviews',
    'Pin a note to the exact second. Your client sees it against the frame, not in a paragraph.',
  ],
  [
    'Coach analytics',
    'Retention, adherence and response rate — the numbers that tell you if your coaching is landing.',
  ],
];
        ...
        <div className="grid gap-12 pt-16 lg:grid-cols-[1.2fr_1fr] lg:items-center">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-relaxed text-bone-200/70">
              Spreadsheets, a scheduling tool, a payments link, a messaging app and a video call —
              replaced by one workspace that already knows what your client did this week.
            </p>
            <div className="mt-9 flex flex-wrap gap-3">
              <ButtonLink href="#apply" size="lg">
                Apply as a Coach
              </ButtonLink>
              <ButtonLink href="/coach" variant="inverse" size="lg">
                See the Workspace
              </ButtonLink>
            </div>
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <h2 className="display text-display-md text-balance">
              FORTY CLIENTS. NOT FOUR HUNDRED.
            </h2>
            <p className="mt-6 max-w-prose leading-relaxed text-muted">
              A coach with four hundred clients is sending templates. FORGE caps rosters at forty
              and shows your utilisation on your own dashboard, because the product only works if
              the coaching is real.
            </p>
            <p className="mt-5 max-w-prose leading-relaxed text-muted">
              Members can see how many slots you have open this week. Coaches at capacity are
              waitlisted rather than quietly oversubscribed — which is better for them, better for
              you, and the reason the average FORGE coaching relationship lasts longer than the
              industry norm.
            </p>
          </div>
          <Card>
            ...
            <ul className="space-y-4">
              {[
                [
                  ...
                  'Level 3 personal training or equivalent, plus any specialisms you claim.',
                ],
                ['Insurance', 'Current professional indemnity and public liability.'],
                [
                  'A written philosophy',
                  'Members choose coaches on how they think, not just what they are certified in.',
                ],
