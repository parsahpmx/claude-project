        ...
        <div className="grid gap-12 pt-16 lg:grid-cols-[1.2fr_1fr] lg:items-center">
          <div>
            ...
            <dl className="mt-12 flex flex-wrap gap-x-12 gap-y-6">
              <Stat label="Client cap" value="40" hint="quality over volume" tone="dark" />
              <Stat label="Platform fee" value="15%" hint="no monthly charge" tone="dark" />
              <Stat label="Payouts" value="Weekly" hint="every Friday" tone="dark" />
            </dl>
          </div>
      ...
      <Section tone="light" size="md">
        ...
        <div className="mt-12 grid gap-px overflow-hidden rounded-card border border-ink-900/10 bg-ink-900/10 sm:grid-cols-2 xl:grid-cols-3">
          {FEATURES.map(([title, body]) => (
            <div key={title} className="bg-bone-100 p-7">
