...
const HOW = [
  {
    ...
    body: 'The marketplace ranks coaches against your goal, budget, language and availability — and shows you why each one ranked where it did.',
  },
  {
    step: '02',
    title: 'Book a free consultation',
    body: 'Thirty minutes, no charge, no commitment. Talk through your history and what has not worked before.',
  },
  {
    step: '03',
    title: 'Get a plan written for you',
    body: 'Not a generated block with your name on it. Your coach writes it, and rewrites it when your week changes.',
  },
  {
    step: '04',
    title: 'Check in every week',
    body: 'Nine questions on a Monday. A written response from a human who read all nine.',
  },
];
...
const INCLUDED = [
  [
    'Weekly check-ins',
    'Energy, sleep, stress, adherence, weight, pain notes and your questions — answered in writing.',
  ],
  [
    'Form review',
    'Send a clip; get notes pinned to the exact second where the position breaks down.',
  ],
  ...
  [
    'Shared nutrition plan',
    'Targets and meals your coach can adjust when your training load changes.',
  ],
];
    ...
    <>
        ...
        <div className="grid gap-12 pt-16 lg:grid-cols-[1.3fr_1fr] lg:items-center">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-relaxed text-bone-200/70">
              Work 1-to-1 with certified professionals who understand your goals. Every coach on
              FORGE holds a recognised qualification, carries insurance and is capped at forty
              clients — because a coach with a hundred clients is coaching none of them.
            </p>
          ...
          <Media
            imageKey="coaching-hero"
            ratio="3/4"
            alt="Coach reviewing a client's training week"
          />
        </div>
      </Section>
      ...
      <Section tone="light" size="md">
        <SectionHeading
          ...
          title="FOUR STEPS TO A COACH WHO KNOWS YOUR NUMBERS."
        />
      ...
      <Section tone="light" size="md">
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          ...
          <div>
            <h2 className="display text-display-md text-balance">THE CHECK-IN IS THE PRODUCT.</h2>
            <p className="mt-6 max-w-prose leading-relaxed text-muted">
              Everything else can be automated. What cannot is somebody reading that you slept badly
              for four nights, that your knee is complaining, and that your week fell apart on
              Wednesday — and changing the plan accordingly before you decide the plan is the
              problem.
            </p>
            <p className="mt-5 max-w-prose leading-relaxed text-muted">
              FORGE scores every check-in and flags what needs attention, so your coach opens with
              the thing that matters rather than scrolling for it. Pain notes go to the top, every
              time.
            </p>
