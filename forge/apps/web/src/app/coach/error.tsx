...
/**
 * Coach workspace error boundary.
 *
...
export default function AppError({
  ...
  if (typeof window !== 'undefined') {
    console.error('Coach workspace error:', error);
  }
  ...
  return (
    <div className="mx-auto max-w-xl py-10">
      <ErrorState
        ...
        body="Your clients' data is safe. This is almost always a temporary connection problem — try again, and if it keeps happening the support team can see the details."
        action={
