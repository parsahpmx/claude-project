  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col p-5">
        ...
        <p className="mt-4 line-clamp-2 text-sm leading-relaxed text-muted">{program.summary}</p>

        <div className="mt-auto flex items-center justify-between pt-5">
          <span className="text-[0.6875rem] uppercase tracking-[0.1em] text-muted">
            {program.progression.replace(/-/g, ' ')}
          </span>
          <span className="text-xs font-semibold uppercase tracking-[0.08em] text-accent transition-transform group-hover:translate-x-0.5">
            View Program →
          </span>
        </div>
      </div>
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="mt-3 flex flex-wrap items-center gap-x-4 gap-y-1 text-xs">
          ...
          <span className="text-muted">{coach.yearsExperience} yrs</span>
        </div>
        ...
        {coach.matchReasons && coach.matchReasons.length > 0 && (
          <p className="mt-3 text-xs leading-relaxed text-accent">{coach.matchReasons[0]}</p>
        )}
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col p-5">
        ...
        <p className="mt-1.5 line-clamp-2 text-xs leading-relaxed text-muted">{product.summary}</p>
