...
export const COACHES: SeedCoach[] = [
  {
    ...
    philosophy:
      'The plan you follow beats the plan that is theoretically optimal. I would rather give you four sessions you will actually do than five you will resent by week three. Technique first, load second, and everything filmed until the position is automatic.',
  ...
  },
  {
    ...
    philosophy:
      'Sequencing is most of the job. Power before strength before conditioning, hard days away from hard days, and honesty about what you can recover from. Autoregulation is not a buzzword; it is how a plan survives a bad month at work.',
  ...
  },
  {
    ...
    firstName: 'Sofia',
    lastName: 'Lindqvist',
    email: 'sofia.lindqvist@forge.fit',
    ...
    philosophy:
      'Sustainable beats fast, every time. I will not write you a deficit you cannot hold for twelve weeks, and I will not ask you to weigh food forever. We build two or three habits that survive a holiday and then we stop changing things.',
  ...
  },
  {
    ...
    philosophy:
      'Volume is earned, never assumed. Ten percent a week, strength work that stays in the plan when the mileage climbs, and a long run that moves to the day you will actually do it. Most running injuries are scheduling failures.',
  ...
  },
  {
    ...
    philosophy:
      'Range you cannot control is not range. Everything we gain gets loaded, tested and kept. I will always refer out when something is clinical rather than mechanical; knowing the edge of your scope is part of coaching.',
  ...
  },
  {
    ...
    firstName: 'Kenji',
    lastName: 'Watanabe',
    email: 'kenji.watanabe@forge.fit',
    ...
    philosophy:
      'Two goals is fine. Two goals with no plan for how they interact is not. I build the week around interference: what blunts what, how far apart it needs to be, and what to cut first when the week collapses.',
...
export const MEMBERS: SeedMember[] = [
  {
    ...
    avatarKey: 'member-alex',
  },
  {
    firstName: 'Priya',
    lastName: 'Anand',
    email: 'priya@forge.fit',
    ...
    avatarKey: 'member-priya',
  },
  {
    firstName: 'Marcus',
    lastName: 'Bell',
    email: 'marcus@forge.fit',
    ...
    avatarKey: 'member-marcus',
  },
  {
    firstName: 'Lena',
    lastName: 'Fischer',
    email: 'lena@forge.fit',
    ...
    tier: 'forge',
    coachSlug: null,
    avatarKey: 'member-lena',
  },
  {
    firstName: 'Tom',
    lastName: 'Okonkwo',
    email: 'tom@forge.fit',
    goal: 'train-for-competition',
    experience: 'advanced',
    daysPerWeek: 5,
    sessionMinutes: 60,
    equipment: ['full-gym'],
    ...
    avatarKey: 'member-tom',
  },
  {
    firstName: 'Yara',
    lastName: 'Haddad',
    email: 'yara@forge.fit',
    goal: 'lose-body-fat',
    experience: 'intermediate',
    daysPerWeek: 4,
    sessionMinutes: 45,
  ...
  },
  {
    ...
    tier: 'forge',
    coachSlug: null,
    avatarKey: 'member-sam',
  },
  {
    firstName: 'Noor',
    lastName: 'Rahman',
    email: 'noor@forge.fit',
    goal: 'build-muscle',
    experience: 'intermediate',
    daysPerWeek: 4,
    sessionMinutes: 60,
...
export const PRODUCTS: SeedProduct[] = [
  {
    ...
    description:
      'A dial-adjust pair covering 2.5kg to 32.5kg in 2.5kg increments — the exact jump size FORGE progression uses, so the plan never asks for a weight you cannot make. Steel plates, nylon-reinforced housing, and a footprint under half a square metre with the tray.',
    priceCents: 74900,
    ...
    reviewCount: 1284,
    specs: {
      'Weight range': '2.5–32.5 kg per dumbbell',
      Increment: '2.5 kg',
      Material: 'Cast steel with nylon housing',
      'Tray dimensions': '78 × 42 × 24 cm',
      Weight: '68 kg (pair with tray)',
    },
    compatiblePrograms: [
      'muscle-builder',
      'fat-loss-engine',
    ...
    warranty: '5-year mechanism, 2-year housing',
    shipping: 'Free delivery, 3–5 working days',
    imageKey: 'product-dumbbells',
  },
  {
    slug: 'olympic-barbell',
    name: 'Olympic Training Barbell',
    category: 'Weights',
    summary: '20kg, 190k PSI tensile, dual knurl marks for powerlifting and weightlifting.',
    description:
      'A bar that will outlast the house. Bronze bushings, moderate knurl that does not shred your hands on high-rep sets, and both knurl marks so it works for a snatch and a bench press.',
    priceCents: 32900,
    compareAtCents: null,
    financingMonths: 6,
    ratingTenths: 49,
    ...
    specs: {
      ...
      Shaft: '28.5 mm',
      Sleeves: 'Bronze bushing',
      Knurl: 'Dual marks, no centre knurl',
    },
    compatiblePrograms: [
      'muscle-builder',
      'strength-foundation',
    ...
    warranty: 'Lifetime against bending under rated load',
    shipping: 'Free delivery, 5–7 working days',
    imageKey: 'product-barbell',
  },
  {
    slug: 'squat-rack',
    name: 'Compact Squat Rack',
    category: 'Benches & Racks',
    summary: 'Full-height rack with safeties and a pull-up bar, in a 1.2m footprint.',
    description:
      'Designed for garages and spare rooms where a full cage will not fit. Laser-cut numbered uprights so you can find your position instantly, safeties rated to 300kg, and a knurled pull-up bar across the top.',
    priceCents: 59900,
    ...
    specs: {
      Height: '215 cm',
      Footprint: '120 × 110 cm',
      Steel: '60 × 60 mm, 2.5 mm wall',
      'Safety rating': '300 kg',
      Holes: '50 mm spacing, numbered',
    },
    compatiblePrograms: [
      'muscle-builder',
      'strength-foundation',
    ...
    shipping: 'Kerbside delivery, 7–10 working days',
  ...
  },
  {
    ...
    description:
      'The ladder-adjust design means no gap between pad and back rest at incline, which is the flaw that makes most home benches unusable for pressing. Firm pad, wide enough for stability, narrow enough for shoulder position.',
    priceCents: 27900,
    compareAtCents: null,
    financingMonths: 6,
    ratingTenths: 48,
    reviewCount: 517,
    specs: {
      Positions: 'Flat to 85° in 7 steps',
      'Load rating': '350 kg',
      'Pad width': '30 cm',
      'Pad density': 'High-density foam, vinyl cover',
      Weight: '32 kg',
    },
    compatiblePrograms: ['muscle-builder', 'strength-foundation', 'womens-strength'],
    goals: ['build-muscle', 'improve-strength'],
    warranty: '5-year frame, 2-year upholstery',
    shipping: 'Free delivery, 3–5 working days',
  ...
  },
  {
    ...
    description:
      'Single-cast iron with a powder coat that holds chalk without tearing your hands. Handle diameter is consistent across the three so the transition between them does not change your grip.',
    priceCents: 24900,
  ...
  },
  {
    ...
    description:
      'Ten-position damper, a performance monitor that streams stroke rate and split to the FORGE workout player over Bluetooth, and a frame that separates into two pieces for storage.',
    priceCents: 89900,
    ...
    reviewCount: 276,
    specs: {
      Resistance: 'Air, 10-position damper',
      Monitor: 'Bluetooth FTMS',
    ...
    warranty: '5-year frame, 2-year monitor',
    shipping: 'Free delivery, 7–10 working days',
  ...
  },
  {
    ...
    description:
      'Layered latex, not moulded, so they stretch further before they fail. The set covers pull-up assistance, band rows, pallof presses and warm-up work — the accessories a travel week needs.',
    priceCents: 5900,
    compareAtCents: null,
    financingMonths: 0,
    ratingTenths: 47,
    ...
    warranty: '1-year',
    shipping: 'Free delivery, 2–3 working days',
    imageKey: 'product-bands',
  },
  {
    slug: 'recovery-mat',
    name: 'Recovery & Mobility Mat',
    category: 'Recovery',
    summary: '8mm, 190cm long, with alignment markings for mobility work.',
    description:
      'Long enough that a 190cm person is not hanging off the end during a supine sequence. Faint alignment lines make positional work checkable without a mirror.',
    priceCents: 7900,
    compareAtCents: null,
    financingMonths: 0,
    ratingTenths: 48,
    reviewCount: 724,
    specs: {
      Dimensions: '190 × 68 cm',
      Thickness: '8 mm',
      Material: 'TPE, closed cell',
      Weight: '1.4 kg',
    },
  ...
  {
    slug: 'massage-gun',
    name: 'Percussive Massage Device',
    category: 'Recovery',
    summary: 'Five speeds, four heads, and quiet enough to use while somebody is asleep.',
    description:
      'Brushless motor at 42dB, six-hour battery, and a pressure sensor that tells you when you are leaning on it hard enough to matter. Four heads for different tissue depths.',
    priceCents: 18900,
  ...
  {
    slug: 'home-gym-starter-bundle',
    name: 'Home Gym Starter Bundle',
    category: 'Bundles',
    summary: 'Adjustable dumbbells, bench, bands and mat. Everything Beginner Foundation asks for.',
    description:
      'The four items that unlock the largest number of FORGE programmes for the smallest footprint. Buying the bundle saves £180 against the items separately, and every programme it unlocks is listed on the product page rather than implied.',
    priceCents: 99900,
    compareAtCents: 116600,
    financingMonths: 24,
    ratingTenths: 49,
    reviewCount: 341,
    specs: {
      Includes: 'Adjustable dumbbells, adjustable bench, band set, recovery mat',
      'Space needed': '2 × 2 m',
      'Programmes unlocked': '9 of 12',
    },
    compatiblePrograms: [
      'muscle-builder',
      'fat-loss-engine',
  ...
  },
  {
    ...
    name: 'Barbell Strength Bundle',
    category: 'Bundles',
    summary: 'Rack, barbell, bench and 150kg of plates.',
    description:
      'A complete barbell setup for Strength Foundation and Muscle Builder. Plates are calibrated rubber-coated so a 2.5kg jump is genuinely 2.5kg and your floor survives.',
    priceCents: 189900,
    compareAtCents: 214600,
    financingMonths: 24,
    ratingTenths: 49,
    reviewCount: 156,
    specs: {
      Includes: 'Squat rack, Olympic barbell, adjustable bench, 150 kg plates',
      'Space needed': '2.5 × 2 m',
    ...
    goals: ['improve-strength', 'build-muscle', 'train-for-competition'],
    warranty: 'As per individual items',
    shipping: 'Kerbside delivery, 10–14 working days',
  ...
  },
  {
    ...
    description:
      'Chest straps remain more accurate than wrist optical during resistance training, where wrist flexion breaks the optical signal. This one pairs to the FORGE player and to your watch simultaneously.',
    priceCents: 7900,
    compareAtCents: null,
    financingMonths: 0,
    ratingTenths: 47,
    ...
    specs: {
      ...
      Battery: '400 hours, CR2032',
      'Water rating': 'IPX7',
      Strap: 'Washable, 60–90 cm',
    },
