...
export const RECIPES: SeedRecipe[] = [
  {
    slug: 'steak-and-sweet-potato-hash',
    name: 'Steak & Sweet Potato Hash',
    summary:
      'A post-training plate built around 48g of protein and enough carbohydrate to refill what the session used.',
    slot: 'dinner',
    calories: 640,
    protein: 48,
    carbs: 52,
  ...
  },
  {
    ...
    name: 'Coriander Chicken Rice Bowl',
    summary:
      'The meal-prep default: five minutes to assemble, 52g of protein, holds in the fridge for three days.',
    slot: 'lunch',
    calories: 620,
    protein: 52,
    carbs: 64,
  ...
  {
    slug: 'salmon-greens-quinoa',
    name: 'Salmon, Greens & Quinoa',
  ...
  {
    slug: 'lentil-walnut-ragu',
    name: 'Lentil & Walnut Ragù',
    summary:
      'A vegan ragù with 26g of protein a serving that genuinely holds its own against the meat version.',
    slot: 'dinner',
    calories: 560,
    protein: 26,
    carbs: 72,
  ...
  },
  {
    ...
    summary:
      'Thirty seconds of blending turns cottage cheese into something you will actually look forward to.',
    slot: 'breakfast',
    calories: 420,
    protein: 32,
    carbs: 40,
  ...
  {
    slug: 'tofu-peanut-noodles',
    name: 'Crispy Tofu Peanut Noodles',
  ...
  {
    slug: 'protein-yoghurt-bark',
    name: 'Frozen Protein Yoghurt Bark',
  ...
  {
    slug: 'egg-avocado-rye',
    name: 'Soft Eggs on Rye',
  ...
  },
  {
    ...
    summary:
      '32g of protein and 45g of carbohydrate, drinkable within ten minutes of racking the bar.',
    slot: 'snack',
    calories: 380,
    protein: 32,
    carbs: 45,
...
export const RECOVERY_SESSIONS: SeedRecovery[] = [
  {
    slug: '10-min-full-body-mobility',
    name: '10-Min Full Body Mobility',
    category: 'Mobility',
    minutes: 10,
    level: 'beginner',
    description:
      'A daily reset covering hips, thoracic spine and shoulders. The one to do when you only have ten minutes.',
    coachSlug: 'sofia-lindqvist',
    imageKey: 'mobility-full',
  },
  {
    slug: 'pre-sleep-breathwork',
    name: 'Pre-Sleep Breathwork',
    category: 'Breathwork',
    minutes: 8,
    level: 'beginner',
    description:
      'Extended exhale breathing to shift you out of sympathetic drive. Do it in bed with the lights off.',
    coachSlug: 'sofia-lindqvist',
    imageKey: 'breathwork-sleep',
  },
  {
    slug: 'hip-mobility',
    name: 'Hip Mobility',
    ...
    level: 'beginner',
    description:
      'Targeted hip work for anyone whose squat depth is limited by position rather than strength.',
    coachSlug: 'maya-roberts',
    imageKey: 'mobility-hips',
  },
  {
    ...
    minutes: 12,
    level: 'beginner',
    description: 'Calves, hamstrings and hip flexors, in the order that matters after a long run.',
    coachSlug: 'amara-diallo',
    imageKey: 'recovery-run',
  },
  {
    slug: 'desk-reset',
    name: 'Desk Reset',
    ...
    level: 'beginner',
    description:
      'Six minutes to undo four hours of sitting. No mat, no changing, do it beside your desk.',
    coachSlug: 'sofia-lindqvist',
    imageKey: 'desk-reset',
  },
  {
    ...
    level: 'beginner',
    description:
      'A body-scan practice for the evening after a hard session, when your head will not switch off.',
    coachSlug: null,
    imageKey: 'meditation',
  },
  {
    ...
    level: 'intermediate',
    description:
      'Upper-back rotation and extension work that makes overhead pressing feel like a different lift.',
    coachSlug: 'daniel-okafor',
    imageKey: 'thoracic',
  },
  {
    slug: 'deep-sleep-wind-down',
    name: 'Deep Sleep Wind-Down',
    category: 'Sleep',
    minutes: 20,
    level: 'beginner',
    description: 'A full pre-sleep protocol: light, temperature, breathing and a short body scan.',
    coachSlug: null,
    imageKey: 'sleep',
  },
  {
    slug: 'lower-body-flush',
    name: 'Lower Body Flush',
    category: 'Recovery Sessions',
    minutes: 14,
    level: 'beginner',
    description:
      'Low-intensity movement and stretching for the day after heavy squats or deadlifts.',
    coachSlug: 'daniel-okafor',
    imageKey: 'lower-flush',
  },
  {
    ...
    level: 'beginner',
    description:
      'Four-count breathing to bring your heart rate down between meetings, or before a heavy top set.',
    coachSlug: null,
    imageKey: 'box-breathing',
  },
];
...
export const ARTICLES: SeedArticle[] = [
  {
    ...
    category: 'Training',
    excerpt:
      'Load is the most obvious lever and the least available one. Four others move faster and break less.',
    ...
    authorName: 'Maya Roberts',
    authorRole: 'Strength & Conditioning Coach',
    readMinutes: 6,
    featured: true,
    imageKey: 'article-overload',
  ...
  },
  {
    ...
    category: 'Nutrition',
    excerpt:
      'The honest answer is a range, and most people are at the bottom of it without meaning to be.',
  ...
  },
  {
    ...
    category: 'Recovery',
    excerpt:
      'A number between 0 and 100 is only useful if you know which input moved and what to do about it.',
  ...
  },
  {
    ...
    category: 'Running',
    excerpt:
      'Easy running works. It does not work better because you did more of it than everybody else.',
    ...
    authorRole: 'Endurance Coach',
    readMinutes: 6,
    featured: false,
    imageKey: 'article-zone2',
  ...
  },
  {
    ...
    category: 'Mindset',
    excerpt:
      'Consistency is not motivation. It is what you have built for the weeks motivation is absent.',
  ...
  },
  {
    ...
    category: 'Science',
    excerpt:
      'Delayed onset muscle soreness is a poor proxy for a good session, and a worse one for progress.',
...
export const SUCCESS_STORIES: SeedStory[] = [
  ...
  },
  {
    ...
    programSlug: '5k-builder',
    programName: '5K Builder',
    timePeriod: '8 weeks',
    consistency: '87% of scheduled sessions',
    coachSlug: 'amara-diallo',
    story:
      'The runner-strength day was the part I would have skipped on my own, and it is the reason my knee held up. Amara moved my long run to Saturday mornings after I missed two Sundays in a row, which sounds trivial and fixed the whole problem.',
    outcomes: [
  ...
  },
  {
    ...
    programSlug: 'bodyweight-strength',
    programName: 'Bodyweight Strength',
    timePeriod: '31 weeks',
    consistency: '74% of scheduled sessions',
    coachSlug: null,
    story:
      'I stopped trying to have good weeks and started trying to have no zero weeks. The 20-minute rebuild button is the single feature that kept me here — I used it more often than the full session, and it still added up.',
    outcomes: [
  ...
  },
  {
    ...
    programSlug: 'hybrid-athlete',
    programName: 'Hybrid Athlete',
    timePeriod: '12 weeks',
    consistency: '95% of scheduled sessions',
    coachSlug: 'daniel-okafor',
    story:
      'I had done both badly for years by doing them on the same days. The sequencing in this plan is the whole trick — the hard run is never within 24 hours of the heavy squat, and everything got better immediately.',
    outcomes: [
